...
void compose_imgui_frame()
{
  ...
  // control window
  {
    ...
    else
    {
      ...
      // TODO: set camera ortho_scale : 완료
...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
  ...
  // TODO: update camera extrinsic parameter with key-inputs1.3118
...
int main(void)
{
  ...
  sglfwSetScrollCallback(window, scroll_callback);
